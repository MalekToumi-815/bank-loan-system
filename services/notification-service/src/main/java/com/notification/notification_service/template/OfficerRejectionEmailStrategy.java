...
public class OfficerRejectionEmailStrategy implements EmailTemplateStrategy {
    ...
    public EmailContent buildEmail(Map<String, String> variables, String frontendUrl) {
        ...
        String officerName = variables.get("officerName");
        ...
        String htmlBody = """
            <div style="font-family: Arial, sans-serif; padding: 20px; color: #333;">
                ...
                <p>Hello %s,</p>
                <p>Your loan Task (ID: <b>%s</b>) was reviewed by officer %s and requires updates.</p>
            </div>
            """.formatted(recipientName, loanId, officerName);
